    ...
    <section className="landing" >
        ...
        <div className="background-image-container"></div>
          ...
          {/* {all below in landing-inner} */}
            ...
            <div className="box-container" style={{ backgroundColor: 'grey',
              ...
              <select value={levelOfStudy} 
                ...
                className='dropdown'
                style={{ fontSize: 'inherit', backgroundColor: 'grey', color: '#e9c78c',  borderRadius: '30px', textAlign: 'center', padding: '8px'}}>
